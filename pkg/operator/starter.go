...
func RunOperator(ctx context.Context, controllerConfig *controllercmd.ControllerContext) error {
	...
	objsToSync := staticresources.SyncObjects{
		...
		ResizerRole:              resourceread.ReadClusterRoleV1OrDie(mustReplaceNamespace(operatorNamespace, "rbac/resizer_role.yaml")),
		ResizerRoleBinding:       resourceread.ReadClusterRoleBindingV1OrDie(mustReplaceNamespace(operatorNamespace, "rbac/resizer_binding.yaml")),
		SnapshotterRole:          resourceread.ReadClusterRoleV1OrDie(mustReplaceNamespace(operatorNamespace, "rbac/snapshotter_role.yaml")),
		SnapshotterRoleBinding:   resourceread.ReadClusterRoleBindingV1OrDie(mustReplaceNamespace(operatorNamespace, "rbac/snapshotter_binding.yaml")),
